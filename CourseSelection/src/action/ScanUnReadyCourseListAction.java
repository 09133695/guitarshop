 ...
 *
 */
public class ScanUnReadyCourseListAction extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		if(isJump()){
			...
			pageQuery = getCourseService().scanUnReadyCourse(pq);
			
		}else if(pageQuery == null || pageQuery.isFirst()){
			
			pageQuery = getCourseService().scanUnReadyCourse();
			
		}else{
			
			pageQuery = getCourseService().scanUnReadyCourse(pageQuery);
